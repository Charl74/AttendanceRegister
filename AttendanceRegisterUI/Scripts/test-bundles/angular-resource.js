 ...
 *   `/user/:classname`. If you are using a URL with a port number (e.g.
...
describe('basic usage', function() {
  ...
  it('should expect a body if hasBody is true', function() {
    var classname = 'yathos';
    var loginRequest = {name: classname, password: 'Smile'};
    var user = {id: 1, name: classname};
